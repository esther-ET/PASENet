...
class DatasetTemplate(torch_data.Dataset):
    def __init__(self, dataset_cfg=None, class_names=None, training=True, root_path=None, logger=None):
        ...
        self.logger = logger
        self.root_path = root_path if root_path is not None else Path(self.dataset_cfg.DATA_PATH)                    # DATA_PATH: '../LiDAR_snow_sim/lib/OpenPCDet/data/dense/pkl'
...
# put the class in gt_boxes as the 8 dimension
...
#
    ...
    def collate_batch(batch_list, _unused=False):
        ...
        # each of the sample is combined by key and val in the batch
