...
class _PointnetSAModuleFSBase(nn.Module):# newlyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy
    ...
    def forward(self,
        ...
        for i in range(len(self.groupers)):
            #myyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy
            # if len(self.groupers[i](xyz, new_xyz, features)) != 2:
            #     continue
