...
#
# import sys
# sys.path.append('/home/ubuntu/wyt/codes/LiDAR_snow_sim/lib/OpenPCDet/pcdet/ops/pointnet2/pointnet2_batch/pointnet2_batch_cuda.cpython-39-x86_64-linux-gnu.so')
...
def furthest_point_sample_matrix(matrix: torch.Tensor, npoint: int) -> torch.Tensor:
    ...
    # pointnet2.farthest_point_sampling_wrapper(B, N, npoint, matrix, temp, output)
    return output
...
def ball_query_dilated(radius_in: float, radius_out: float, nsample: int, xyz: torch.Tensor, new_xyz: torch.Tensor):
    ...
    # pointnet2.ball_query_wrapper(B, N, npoint, radius_out, nsample, new_xyz, xyz, idx)
