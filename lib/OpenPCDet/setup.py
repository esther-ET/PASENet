...
if __name__ == '__main__':
    ...
    write_version_to_file(version, '/home/ubuntu/wyt/codes/LiDAR_snow_sim/lib/OpenPCDet/pcdet/version.py')
    ...
    setup(
        ...
        ext_modules=[
            make_cuda_ext(
                name='iou3d_nms_cuda',
                module='lib.OpenPCDet.pcdet.ops.iou3d_nms',
                sources=[
                    'src/iou3d_cpu.cpp',
            ...
            make_cuda_ext(
                ...
                module='lib.OpenPCDet.pcdet.ops.roiaware_pool3d',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='lib.OpenPCDet.pcdet.ops.roipoint_pool3d',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='lib.OpenPCDet.pcdet.ops.pointnet2.pointnet2_stack',
                sources=[
            ...
            make_cuda_ext(
                ...
                module='lib.OpenPCDet.pcdet.ops.pointnet2.pointnet2_batch',
                sources=[
                    'src/pointnet2_api.cpp',
                    'src/ball_query.cpp',
                    'src/ball_query_gpu.cu',
